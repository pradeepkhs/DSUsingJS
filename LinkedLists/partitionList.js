...
class LinkedList {
    ...
    // //my solution
    // partitionList(x) {
    //     let dummy1 = new LinkedList(0), dummy2 = new LinkedList(0);
    //     let ll = this.head;

    //     while(ll !=null) {
    //         if(ll.value < x) {
    //             dummy1.push(ll.value);
    //         } else {
    //             dummy2.push(ll.value);
    //         }

    //         ll = ll.next;
    //     }
        
    //     let prev1 = dummy1.head.next;
    //     let prev2 = dummy1.head.next;
    //     while(prev1 !=null) {
